...
import PoppleTestCases.ReportGenerateTest;
import PoppleUtils.WrapperGenericMethod;

public class SearchPage extends ReportGenerateTest{
	...
	By SearchHeader = By.cssSelector("body > div.vtpl-container > div > div:nth-child(1) > p");
	...
	public void ClickSearchOption(WebDriver driver) throws InterruptedException {
		...
		Action.Sendkeys(driver, SearchBox, "Lavish Celebrity");
		Thread.sleep(2000);

		driver.get("https://www.thepopple.com/search?q=Lavish Celebrity");
