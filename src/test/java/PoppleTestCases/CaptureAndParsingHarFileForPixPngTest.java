...
public class CaptureAndParsingHarFileForPixPngTest extends ReportGenerateTest {
...
/*	@BeforeTest
	...
	public void OpenGoogleappsHar_analyzer() {
		...
		driver.manage().window().maximize();
		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/var/www/html/pop_jen/Thepopple/thepopple.har");
