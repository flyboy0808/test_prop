...
public class CaptureAndParsingHarFileForPixPngTest extends ReportGenerateWittyTest {
...
//
//			driver.navigate().to("https://www.wittyfeed.tv/what-happened-at-the-star-screen-awards-2018-72192?utm_source=homepage_promo");
...
//
//			File harFile = new File("/home/wittyfeed/WittyFeed.har");
//			har.writeTo(harFile);
//
...
//	}
	...
	public void OpenGoogleappsHar_analyzer() {
		...
		driver.manage().window().maximize();
		driver.findElement(By.cssSelector("#fileSelector")).sendKeys("/var/www/html/wittyfeedtv/wittyfeedTv/WittyFeed.har");
